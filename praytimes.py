...
class PrayTimes():
    ...
    # do notchange anything here; use adjust method instead
    settings= {
        "imsak"    : '10 min',
        "dhuhr"    : '0 min',
        "asr"      : 'Standard',
    ...
    # returnprayer times for a given date
    ...
    # adjusttimes in a prayer time array
    ...
    # returnsun angle for sunset/sunrise
    ...
    # adjusttimes for locations in higher latitudes
    ...
    # adjusta time for higher latitudes
